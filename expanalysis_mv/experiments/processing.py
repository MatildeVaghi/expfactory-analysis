...
from expanalysis_mv.experiments.jspsych_processing import adaptive_nback_post, \
...
from expanalysis_mv.experiments.jspsych_processing import calc_adaptive_n_back_DV,\
...
from expanalysis_mv.experiments.survey_processing import \
    calc_survey_DV, calc_bis11_DV, calc_eating_DV, calc_leisure_time_DV, calc_lon_socsup_pss_pre_DV, calc_lon_socsup_pss_post_DV, \
    calc_lsas_DV, calc_SSS_DV, calc_SSS_corrlayout_DV, calc_demographics_DV, calc_demographics_covid_DV, \
    future_time_post, self_regulation_survey_post, sensation_seeking_survey_post, sensation_seeking_survey_correctlayout_post
from expanalysis_mv.experiments.utils import get_data, lookup_val, select_experiment, drop_null_cols
import pandas
import numpy
import os
import time
...
def post_process_exp(df, exp_id):
    ...
    lookup = {'adaptive_n_back': adaptive_nback_post,
              ...
              'holt_laury_survey_correctlayout': holt_laury_post,
              ...
              'sensation_seeking_survey_correctlayout': sensation_seeking_survey_correctlayout_post,
...
def export_experiment(filey, data, exp_id, clean = True):
    ...
    """
    df = df = extract_experiment(data, exp_id, clean)
...
def calc_exp_DVs(df, use_check = True, use_group_fun = True, group_kwargs=None):
    ...
    lookup = {'adaptive_n_back': calc_adaptive_n_back_DV,
              ...
              'demographics_survey__stanford__covid': calc_demographics_covid_DV,
              ...
              'holt_laury_survey_correctlayout': calc_holt_laury_DV,
              ...
              'selection_optimization_compensation_survey_correctlayout': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='selection_optimization_compensation_survey_correctlayout'),
              ...
              'sensation_seeking_survey_correctlayout': calc_SSS_corrlayout_DV,
              'simon': calc_simon_DV,
              ...
              'psychopathology_aes_survey__covid': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='psychopathology_aes_survey__covid'),
              'psychopathology_eat26_survey__covid': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='psychopathology_eat26_survey__covid'),
              'psychopathology_lsas_survey__covid': calc_lsas_DV,
              'psychopathology_ocir_survey__covid': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='psychopathology_ocir_survey__covid'),
              'psychopathology_sds_survey__covid': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='psychopathology_sds_survey__covid'),
              'psychopathology_sms_survey__covid': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='psychopathology_sms_survey__covid'),
              'psychopathology_stai_survey__covid': lambda df, use_check: calc_survey_DV(df, use_check, survey_name='psychopathology_stai_survey__covid'),
              'loneliness_socialsupport_stress_post_survey__covid': calc_lon_socsup_pss_post_DV,
              'loneliness_socialsupport_stress_pre_survey__covid' : calc_lon_socsup_pss_pre_DV,
              'mindset_illness_stress_survey__covid' : lambda df, use_check: calc_survey_DV(df, use_check, survey_name='mindset_illness_stress_survey__covid'),
              }
